...
import NoLocalStorage from '../index.js';

let mockedStorage = {};

describe('Unit test suit', function() {
  beforeEach('Mock window.localStorage', function() {
    let mockedWindow = {
      localStorage: {
        length: 0
      },
  ...
  afterEach('Cleanup window and NoLocalStorage properties', function() {
    NoLocalStorage.nativeLocalStorage = undefined;
    global.window = undefined;
    mockedStorage = {};
  });

  it('disable() prevents to get item', function() {
  ...
  it('disable() gets whitelisted item', function() {
    window.localStorage.foo = 1;
  ...
  it('disable() prevents to set item', function() {
    NoLocalStorage.disable();
  ...
  it('disable() sets whitelisted item', function() {
    NoLocalStorage.disable(['foo']);
    window.localStorage.foo = 2;
  ...
  it('disable() and remove an item does nothing', function() {
    window.localStorage.foo = 1;
    NoLocalStorage.disable();
  ...
  it('disable() removes a whitelisted item', function() {
    window.localStorage.foo = 1;
    NoLocalStorage.disable(['foo']);
  ...
  it('disable() clears added whitelisted items', function() {
  ...
  it('disable() iterates whitelisted items with key()', function() {
    window.localStorage.foo = 1;
